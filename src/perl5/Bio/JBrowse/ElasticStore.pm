...
Bio::JBrowse::ElasticStore - elastic store name index

=head1 DESCRIPTION

elasticsearch store for genomic data

=cut

package Bio::JBrowse::ElasticStore;
use strict;
use warnings;
...
my $bucket_class = 'Bio::JBrowse::ElasticStore::Bucket';
...
sub _make_cache {
    my ( $self, @args ) = @_;
    return Bio::JBrowse::ElasticStore::FIFOCache->new( @args );
}
...
package Bio::JBrowse::ElasticStore::Bucket;
...
package Bio::JBrowse::ElasticStore::FIFOCache;
